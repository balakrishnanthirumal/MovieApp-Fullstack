...
const Navigation = () => {
  ...
  return (
    <div className="fixed bottom-10 left-[20rem] transform translate-x-1/2 translate-y-1/2 z-50 bg-[#0f0f0f] border w-[30%] px-[4rem] mb-[2rem] rounded">
      <section className="flex justify-between items-center">
        {/* section1 */}
        <div className="flex justify-center items-center mb-[2rem]">
          <Link
            to="/"
            className="flex items-center transition-transform transform hover:translate-x-2 duration-100"
          >
            <AiOutlineHome className="mr-2 mt-[3rem] size-5" />
            <span className="hidden nav-items mt-[3rem]">Home</span>
          </Link>
          ...
          >
            <MdOutlineLocalMovies className="mr-2 mt-[3rem] size-5" />
          ...
          {!userInfo && (
            <ul className="flex">
              <li>
                ...
                >
                  <AiOutlineLogin className="mr-2 mt-[4px] size-5" />
